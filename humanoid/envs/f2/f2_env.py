...
from .f2_cfg_amp import F2AMPCfg
import torch
...
class F2Env(BaseTask):
    def __init__(self, cfg: Union[F2AMPCfg], sim_params, physics_engine, sim_device, headless):
